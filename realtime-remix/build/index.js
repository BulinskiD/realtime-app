...
// route-module:C:\privateProjects\realtime\realtime-remix\app\root.tsx
var root_exports = {};
...
// route-module:C:\privateProjects\realtime\realtime-remix\app\routes\404.tsx
var __exports = {};
__export(__exports, {
  default: () => FourOhFour,
  meta: () => meta
...
// route-module:C:\privateProjects\realtime\realtime-remix\app\routes\game\$userName\$id.tsx
var id_exports = {};
__export(id_exports, {
  default: () => GameBoard
});
...
// app/services/wsService.ts
var import_socket = __toModule(require("socket.io-client"));
var socket = (0, import_socket.io)(`http://localhost:5000`);
var wsService = {
  getGameConnection: (id) => (0, import_socket.io)(`http://localhost:5000/game/${id}`)
};

// app/utils/useUsername.ts
var import_react_router_dom6 = __toModule(require("react-router-dom"));
function useUsername() {
  const {userName} = (0, import_react_router_dom6.useParams)();
  return userName;
}
...
function GameBoard() {
  ...
  const [game, setGame] = React7.useState(null);
  const {id} = (0, import_react_router_dom7.useParams)();
  const gameSocket = React7.useMemo(() => wsService.getGameConnection(id), [id]);
  React7.useEffect(() => {
  ...
  return /* @__PURE__ */ React7.createElement("div", null, game == null ? void 0 : game.user1, " ", game == null ? void 0 : game.user2);
}

// route-module:C:\privateProjects\realtime\realtime-remix\app\routes\game\$userName\index.tsx
...
var httpService = {
  get: (url) => fetch(`${API_URL}/${url}`, {headers: defaultHeaders}).then((res) => res.json()),
...
// app/services/gamesService.ts
var gamesService = {
  getAll: () => httpService.get("games"),
  create: (userName) => httpService.post("games", {userName})
};

// route-module:C:\privateProjects\realtime\realtime-remix\app\routes\game\$userName\index.tsx
var import_node = __toModule(require("@remix-run/node"));
var React8 = __toModule(require("react"));
var loader2 = () => gamesService.getAll();
var action = async ({params}) => {
  console.log(params);
  const {gameId} = await gamesService.create(params.userName);
  return (0, import_node.redirect)(`/game/${params.userName}/${gameId}`);
};
function Games() {
  const userName = useUsername();
  const games = useRouteData();
  return /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("form", {
    method: "post"
  }, /* @__PURE__ */ React8.createElement("button", null, "New Game")), games.map((game) => {
    var _a;
    return /* @__PURE__ */ React8.createElement(import_react_router_dom4.Link, {
      key: game.id,
      to: `/game/${userName}/${game.id}`
    }, /* @__PURE__ */ React8.createElement("button", null, "User1: ", game.user1, " User2: ", (_a = game.user2) != null ? _a : "Free"));
  }));
}

// route-module:C:\privateProjects\realtime\realtime-remix\app\routes\index.tsx
var routes_exports = {};
...
var action2 = async ({request}) => {
  const userName = new URLSearchParams(await request.text()).get("userName");
  return (0, import_node2.redirect)(`/game/${userName}`);
};
function Index() {
  ...
  }), /* @__PURE__ */ React9.createElement("button", null, "Submit"));
}
...
var routes = {
  ...
  "routes/game/$userName/$id": {
    id: "routes/game/$userName/$id",
    parentId: "root",
    path: "game/:userName/:id",
    caseSensitive: false,
    module: id_exports
  },
  "routes/game/$userName/index": {
    id: "routes/game/$userName/index",
    parentId: "root",
    path: "game/:userName",
    caseSensitive: false,
